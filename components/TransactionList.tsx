          ...
          days.map(day => {
            ...
            return (
              <div key={day} id={`day-${day}`} className="mb-8 last:mb-0 border border-slate-200/60 rounded-3xl bg-white/40 shadow-sm">
                ...
                {/* HEAD: SALDO INICIAL */}
                <div className="sticky top-0 z-20 flex items-center justify-between px-6 py-3 bg-blue-100/95 backdrop-blur-md border-b border-blue-200/50 rounded-t-3xl shadow-sm">
